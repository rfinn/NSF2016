...
\vspace*{-.8cm}
\section{This study: A Survey of Gas in Filament Galaxies}
\vspace*{-.4cm}
...
We have successfully completed the first of two awarded CO observing campaigns to directly measure the molecular gas content of galaxies within these filaments. To fully leverage this unique data set, we will obtain \ha\ observations, which will yield spatially resolved star formation rates of filament galaxies. Combining this new data set with publicly available WISE infrared imaging, GALEX UV fluxes,  and ALFALFA HI gas masses will allow us to characterize filament galaxies in a way that is on par with galaxies in the Virgo core. 
\input{sample}
