...
It is novel and guaranteed to succeed for several reasons:  
we move beyond field/group/cluster trilogy and instead focus on filaments
we have extensive multi-wavelength data and a reliable path to obtain that remaining
we have in house models to interpret data
we have the expertise to carry out the analysis

The expected outcomes are:
constraints on gas effects
understanding of spatial modification of SF and gas supply
extension to all of SDSS
