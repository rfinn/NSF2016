...
Studying the relative distribution
...
\includegraphics[width=.4\textwidth]{gomez2003-fg6a.png}
...
of scatter may come from large range in local densities in the filamentary structure surrounding clusters.  This
implies that understanding the impact of environmental processes requires studying galaxies along
filaments and not just as a function of projected radius, which is the goal of this proposal.}
     \label{fig1}
 \end{figure}
