...
clusters and groups.  These filaments are well defined in SDSS data
(Fig.~\ref{kimfigure}).  In this application we propose to make a
comprehensive determination of the warm ionized, neutral, and
...
combine data from the literature with our own data from ongoing
observing campaigns and compare these obervations with in-house
theoretical models.  This will allow us to test whether the filament
environment is an important driver of gas stripping or the truncation
of gas accretion from the cosmic web.  We are well prepared to carry
...
\begin{figure*}[h!]
\begin{center}
\includegraphics[width=.7\textwidth]{lizhi_comparison.png}
\end{center}
