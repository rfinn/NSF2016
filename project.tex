...
sites of significant environmetally-driven quenching.  For example, \citet{cybulski14} find that
 ...
 star formation and don't have direct measures of the neutral and molecular gas content.
...
\noindent $\bullet$ \textbf{Find the effect filaments
...
$\rightarrow$ 
We have in-house semi-analytic models that make robust predictions for
...
these models we will be able to determine what mechanisms are dominant
and in what environmental regime. 
...
\begin{figure}[h]
   \centering
 %\includegraphics[width=.48\textwidth]{CLUES-DM.png}
\includegraphics[width=.39\textwidth]{decision_tree.png}
   \caption{\small  .}
     \label{decisiontree}
 \end{figure}
...
(c) {\bf Measured} half-light radius of stars (bottom) and star
...
We describe the majors components of our proposed work below.
